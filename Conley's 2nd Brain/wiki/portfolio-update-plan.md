...
Seven sections: Homepage → About → Work → Projects → Consulting → Capabilities → Writing

The plan doesn't restructure the site. It makes targeted edits within the existing structure.

---

## What NOT to Say Anywhere in Public Copy

- The automation stack (n8n, Apify, Apollo, AI model names)
- That fulfillment is near-fully automated or runs without significant human involvement
...
**1. Replace the "three domains / what I do" section with:**

> I work at the intersection of marketing operations and systems architecture. Day job: leading AI integration and digital transformation at AutoBoost, a marketing automation company in Pennsylvania. Side work: building ACE — a pipeline infrastructure for AI-assisted professional services. Long-range project: The Sentinel, a hardware AI prototype I'm funding through the above.
>
> That's the portfolio version. The honest version is that I spend a lot of time trying to figure out how to do work that compounds — systems that get more valuable over time, not just deliverables that disappear after the invoice.
...
The test: read each paragraph aloud. If it sounds like a LinkedIn bio, revise it.
...
These things are working and should be preserved exactly:
...
## After All Queries Are Complete — QA Checklist
